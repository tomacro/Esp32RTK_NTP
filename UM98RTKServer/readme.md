...
This repository is an optimized, high-performance fork of the baseline [mctainsh/UM98RTKServer](https://github.com/mctainsh/Esp32/blob/main/UM98RTKServer/README.md). While the original repository provides an excellent baseline for streaming raw RTCM3 data from a Unicore GNSS module to a single caster, this version introduces concurrent multi-caster casting alongside an isolated local Stratum-1 Network Time Protocol (NTP) server disciplined by a hardware 1PPS pulse.
